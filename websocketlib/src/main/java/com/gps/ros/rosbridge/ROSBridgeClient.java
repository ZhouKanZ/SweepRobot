...
public class ROSBridgeClient extends ROSClient {
    ...
    public String[] getNodes() throws InterruptedException {
        ...
        nodeService = new Service<Empty, Nodes>("/rosapi/nodes", Empty.class, Nodes.class, this);
    ...
    private String getTopicType(String topic) throws InterruptedException {
        Service<com.gps.ros.rosapi.message.Topic, Type> topicTypeService =
                new Service<com.gps.ros.rosapi.message.Topic, Type>("/rosapi/topic_type",
                        com.gps.ros.rosapi.message.Topic.class, Type.class, this);
        return topicTypeService.callBlocking(new com.gps.ros.rosapi.message.Topic()).type;
    }
    
    private String getServiceType(String service) throws InterruptedException {
        Service<com.gps.ros.rosapi.message.Service, Type> serviceTypeService =
                new Service<com.gps.ros.rosapi.message.Service, Type>("/rosapi/service_type",
                        com.gps.ros.rosapi.message.Service.class, Type.class, this);
        return serviceTypeService.callBlocking(new com.gps.ros.rosapi.message.Service(service)).type;
    }
    ...
    public void typeMatch(TypeDef t, Class<? extends Message> c) throws InterruptedException {
        ...
        for (int i = 0; i < t.fieldnames.length; i++) {
            ...
            System.out.println(" field name  ------------------:   "+ typeFieldName);
