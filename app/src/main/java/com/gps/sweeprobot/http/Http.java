...
import com.gps.sweeprobot.utils.NetworkUtil;
import com.gps.sweeprobot.utils.SpUtils;
        ...
        if (retrofit == null) {
            synchronized (Http.class) {
                if (retrofit == null) {
                    ...
                    //设置 请求的缓存的大小跟位置
                    File cacheFile = new File(MainApplication.getContext().getCacheDir(), "cache");
